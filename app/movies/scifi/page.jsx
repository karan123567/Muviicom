...
export default function SciFiMovies() {
  ...
  const fetchMovies = async (category) => {
    ...
    try {
      ...
      const url = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=878&language=en-US&page=1${
    ...
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="relative w-full h-[70vh] overflow-hidden">
        <video
          ...
          playsInline
        >
          <source src="/videos/scifi.mp4" type="video/mp4" />
        </video>
      </div>
            ...
            <Tilt key={movie.id} tiltMaxAngleX={10} tiltMaxAngleY={10}>
              <motion.div
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow:
                    "0 0 15px #00FFFF, 0 0 30px #0FF, 0 0 45px #00FFFF", // neon cyan glow
                }}
      ...
      <AnimatePresence>
        {selectedMovie && (
          ...
          >
            <motion.div
              className="bg-gray-900 rounded-2xl p-6 w-full max-w-sm sm:max-w-md md:max-w-3xl border-2 border-cyan-400 shadow-[0_0_20px_#00FFFF]"
              initial={{ scale: 0.7 }}
              animate={{ scale: 1 }}
              exit={{ scale: 0.7 }}
            ...
            >
              <button
                onClick={closeModal}
                className="absolute top-4 right-4 z-50 text-cyan-400 hover:text-cyan-600 text-2xl pointer-events-auto"
              >
                ✖
              </button>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <img
                  ...
                  className="w-full md:w-60 rounded-xl shadow-lg border border-cyan-400 object-cover"
                />
                <div className="flex-1">
                  <h2 className="text-2xl md:text-3xl font-bold text-cyan-400 drop-shadow-[0_0_10px_#00FFFF]">
                    {selectedMovie.title}
                  </h2>
                  ...
                  <div className="mt-4">
                    <h3 className="font-semibold text-lg text-cyan-400 drop-shadow-[0_0_10px_#00FFFF]">
                      Top Cast:
                    </h3>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-gray-300 text-sm md:text-base">
                      Must-watch for sci-fi lovers! Futuristic worlds, epic
                      adventures, and mind-bending stories.
                    </p>
                  </div>
                </div>
              </div>
