    ...
    <div className="relative bg-black text-white min-h-screen overflow-x-hidden">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden flex items-center justify-center m-0 p-0">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <h1 className="text-4xl md:text-6xl font-bold text-blue-500 drop-shadow-lg">
            Comedy Movies
          </h1>
        </div>
      </section>
      ...
      <div className="flex justify-center flex-wrap filter-buttons z-10 relative py-6 gap-2">
        {[
          ...
          <button
            ...
            className={`capitalize px-4 py-2 rounded-lg border border-blue-500 transition-all duration-300 ${
              filter === cat
                ? "bg-blue-600 text-white shadow-lg shadow-purple-500/50"
          ...
          >
            <motion.div
              whileHover={{
                ...
                rotateY: 5,
                boxShadow:
                  "0 0 16px #00BFFF, 0 0 28px #1E90FF, 0 0 44px #4169E1",
              }}
              transition={{ type: "spring", stiffness: 280, damping: 20 }}
              className="rounded-xl overflow-hidden cursor-pointer bg-[#0b0b0b] border border-blue-900/40 shadow-[0_0_8px_rgba(0,0,255,1)] group relative"
      ...
      {visibleCount < filterMovies(movies).length && (
        <div className="flex justify-start px-6 pb-12">
          <motion.button
            ...
            className="px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl font-semibold text-white shadow-lg shadow-blue-500/50"
          >
            See More
          </motion.button>
        </div>
          ...
          >
            <div className="max-w-5xl mx-auto p-6">
              <button
                ...
                className="mb-4 px-4 py-2 bg-blue-500 text-black rounded hover:bg-blue-400"
              >
                Close
              </button>
              ...
              <h3 className="mt-6 mb-3 text-2xl font-semibold text-blue-500">
                More Comedy Movies
              </h3>
                ...
                {movies.map((m) => (
                  <div key={m.id} className="min-w-[150px]">
                    <img
                      ...
                      alt={m.title}
                      className="rounded-xl hover:shadow-[20px_20px_20px_#ff69b4] transition cursor-pointer"
